...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		fearBar = new FlxBar(fearBarBG.x + 4, fearBarBG.y + 4, LEFT_TO_RIGHT, Std.int(fearBarBG.width - 8), Std.int(fearBarBG.height - 8), this, 'fear', 0, 1,
			false);
		...
		fearBarText.moveText(fearBarBG.x - fearBarText.width - 16, fearBarBG.y - fearBarText.height / 2);
	...
	{
		flavioMic = new FlxSprite().loadGraphic(Paths.image('microphone', 'flavio'), false, Std.int(boyfriend.width / 2), Std.int(boyfriend.height / 2));
